...
export function FinanceControlClient({ initialTransactions, userId }: FinanceControlClientProps) {
  ...
  const transactionsByMonth = useMemo(() => {
    return transactions.reduce((acc, transaction) => {
      const month = new Intl.DateTimeFormat("pt-BR", { month: "long", year: "numeric" }).format(transaction.date)
      ...
      acc[month].balance += transaction.type === "INCOME" ? transaction.amount : -transaction.amount
      ...
      <div className="container mx-auto p-4 min-h-screen bg-background text-foreground">
        ...
        <Card className="mb-6">
          ...
          <CardContent>
            ...
            <div className="flex space-x-2">
              ...
              <Button onClick={() => addTransaction("expense")} variant="destructive" className="flex-1">
        ...
        <Card>
          ...
          <CardContent>
            ...
            {Object.entries(transactionsByMonth).map(([month, { transactions, balance }]) => (
